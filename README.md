...
> **Status: M0 — scaffold.** Project skeleton builds; the real pipeline
> (TCI client → channelizer → decoders) lands milestone by milestone. See
> [`docs/SCOPE.md`](docs/SCOPE.md) for the full plan.
